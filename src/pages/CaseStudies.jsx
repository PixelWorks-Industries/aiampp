      ...
      <main>
        <section className="page-hero">
          <div className="wrap">
            ...
            <p className="lede">
              Intelligence is not judgment. We are letting agentic AI make decisions before teaching it what matters most: good human judgment. Sometimes it borrows from a
              prompt we typed in a hurry. Sometimes from the average of the internet. Sometimes from the company that built the system long before we showed up. The problem
              is that we rarely know whose judgment it is borrowing, and a generation that already trusts almost nothing is now being asked to trust decisions no one can
              explain. The companies that win keep three controls human, then wire three gears of AI behind them. Here is the approach, and the proof.
            </p>
          </div>
        </section>
          ...
          <div className="wrap" style={{ paddingInline: 0 }}>
            <div className="stats-grid" style={{ gridTemplateColumns: '1fr 1fr' }}>
              <div className="stat" style={{ paddingLeft: 'var(--pad-x)' }}>
                ...
                <div className="lbl">
                  <b style={{ color: 'var(--white)' }}>Amplified value</b> - three controls present. Friction and uncertainty removed, trust delivered, at scale.
                </div>
              </div>
              <div className="stat" style={{ paddingRight: 'var(--pad-x)' }}>
                <div className="num" style={{ color: 'var(--mist-dim)' }}>95%</div>
                <div className="lbl">
                  <b style={{ color: 'var(--white)' }}>Amplified noise</b> - controls missing. Expensive, confident-sounding mistakes.
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="wrap">
            ...
            <div className="eng-list">
              <Link className="eng" to="/davids-bridal">
                ...
                <div className="meta">
                  <div className="meta-top"><b>1 to 18-month</b> relationship - NPS 19 to 73</div>
                  <div className="meta-sub">$4B dresses to $65B full-journey market</div>
                </div>
              ...
              <Link className="eng" to="/vodafone-trade-in">
                ...
                <div className="meta">
                  <div className="meta-top"><b>5x trade-in volume</b> - NPS +32 over industry</div>
